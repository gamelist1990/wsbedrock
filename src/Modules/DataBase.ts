...
export function saveData(key: string, value: any): void {
  ...
  world.setDynamicProperty('wsserver_v2', data);
}
...
export function loadData(): void {
  system.run(() => {
    const data = world.getDynamicProperty('wsserver_v2');
...
export function resetData(): void {
  ...
  world.sendMessage("§l§eWarn §aChestLockAddon v2 DataBase is Reset");
}
